<section class="desktop-wrapper">
  ...
  <section class="landing-wrapper">
    <div class="landing-wrapper__info-wrapper info-wrapper">
      ...
      <img
        class="info-wrapper__landing-image"
        src="img/figure-1954-1.jpg"
        alt="landing-image"
      >
      <h1 class="info-wrapper__title">
        <img src="img/title-w.svg" alt="title">
      </h1>
    </div>
  </section>
  <section bind:this={articleWrapper} class="article-section-wrapper">
    ...
    <div class="article-wrapper">
      ...
      <article class="article article--1980">
        <Figure
          class="figure1"
        ...
        >
          ...
          <div class="info__info-description info-description">
            <p>25 歲的潘小俠，讀了劉其偉所寫的《台灣土著藝術》，對書中描述當時蘭嶼的丁字褲、銀盔、拼板舟大感好奇，自己帶了相機就出發前往蘭嶼。16 個小時的交通距離，他從一開始陌生、誤觸禁忌，到後來透過酒精與達悟族人變朋友，他的鏡頭慢慢成為蘭嶼人生活的一部分。</p>
          </div>
        </div>
      </article>
      <article class="article article--1986">
        <Figure
          class="figure1"
      ...
      <article class="article article--1990">
          <Figure
            class="figure1"
      ...
      <article class="article article--1999-2002">
        <Figure
          class="figure1"
      ...
      <article class="article article--2005">
        <Figure
          class="figure1"
      ...
      <article class="article article--2006">
        <Figure
          class="figure3"
        ...
        <div class="article__info info">
          ...
          <div class="info__info-description info-description">
            <p>5 年間潘小俠陸續造訪蘭嶼，為島上達悟族人留下不同時期的身影，一張張照片，帶領觀者一起經歷和小島從陌生、熟悉到被擁抱的過程，所有尋常與不尋常都化作寧靜的黑白定格，即使褪去新奇或獵奇感，依然雋永。</p>
          </div>
        </div>
      </article>
      <article class="article article--2009">
        <Figure
          class="figure3"
        ...
        <div class="article__info info">
          ...
          <div class="info__info-description info-description">
            <p>潘小俠在自立報系工作期間，採訪過白色恐怖受難者王拓、柏楊、陳映真、等作家，開啟他對白色恐怖的認識，記錄 99 位政治受難者的影像集結成冊，成為國內少見針對白色恐怖歷史當事人或遺族進行肖像拍攝的作品。</p>
          </div>
        </div>
      </article>
      <article class="article article--2015">
        <Figure
          class="figure1"
      ...
      <article class="article article--2017">
        <Figure
          class="figure1"
      ...
      <article class="article article--2020">
        <Figure
          class="figure1"
...
<style lang="scss">
  ...
  .article {
    ...
    &--1954 {
      grid-template-areas: "figure1 figure2 figure2 info";
    }
    &--1980 {
      grid-template-areas: ". figure1 figure1 info";
    }
    &--1986 {
      grid-template-areas:  "figure1 figure1 figure1 info"
                            "figure2 figure2 figure3 .";
    }
    &--1990 {
      grid-template-areas:  ". figure1 figure1 info"
                            "figure2 figure3 figure3 ."
                            "figure4 figure4 figure5 ."
